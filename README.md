...
- **[advent-5x5-hands-on-template](https://github.com/kskmasa/advent-5x5-hands-on-template)** — 5日×5テーマのハンズオンAdventテンプレート  
  <sub><span style='display:inline-block;width:10px;height:10px;background:#3572A5;border-radius:50%;vertical-align:middle;margin-right:6px'></span>Python • ⭐ 0 • updated 123d ago</sub>
- **[UseGithubHowTo](https://github.com/kskmasa/UseGithubHowTo)** — No description  
  <sub><span style='display:inline-block;width:10px;height:10px;background:#cccccc;border-radius:50%;vertical-align:middle;margin-right:6px'></span>- • ⭐ 0 • updated 130d ago</sub>
<!-- PROJECTS:END -->
